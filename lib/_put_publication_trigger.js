...
if (copyright_owner !== "No copyright owner") {
 ...
 for (let component of all_components) {
   ...
   if (map_copyright_fields[copyright_owner] && map_copyright_fields[copyright_owner][field_name]) {
     component.label = map_copyright_fields[copyright_owner][field_name];
